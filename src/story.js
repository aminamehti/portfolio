...
// Uncommented Chalk as it is not used in this example
...
function generatePrompt(prompt, direction, lastChoice) {
  ...
  switch (direction) {
    case "Middle":
      return `${basePrompt}${choiceInstruction} ${prompt} Now, develop the story further. This part should elaborate on the implications of the previous choice and end with two distinct options for the character, labeled as \nOption A and \nOption B.${storyConsistency} Keep the name of the character the same as in the previously generated text. In your text response, ALWAYS start listing option A and B on a new line. DO NOT BOLD ANY TEXT IN THE STORY. DO NOT INCLUDE ANY SPECIAL SYMBOLS (such as: (), *, '' or any other) IN RESPONSE. Limit response to 200 words.`;
    case "End":
    ...
    default:
      ...
      return `${basePrompt} ${prompt}${choiceInstruction} Begin by introducing the main character and setting up the initial situation. Finish this part with two options for the character, labeled as \nOption A and \nOption B.${storyConsistency} In your text response, ALWAYS start listing option A and B on a new line. DO NOT BOLD ANY TEXT IN THE STORY. DO NOT INCLUDE ANY SPECIAL SYMBOLS (such as: (), *, '' or any other) IN RESPONSE. Limit response to 200 words.`;
  }
}
